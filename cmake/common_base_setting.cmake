...
if(CMAKE_BUILD_TYPE AND (CMAKE_BUILD_TYPE STREQUAL "Debug"))
    ...
    message(STATUS "common_base_setting define Debug mode:${CMAKE_C_FLAGS_DEBUG}")
elseif(CMAKE_BUILD_TYPE AND (CMAKE_BUILD_TYPE STREQUAL "Release"))
    set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS} -Wall -O3")
    message(STATUS "common_base_setting define Release mode:${CMAKE_C_FLAGS_RELEASE}")
elseif(CMAKE_BUILD_TYPE AND (CMAKE_BUILD_TYPE STREQUAL "Custom"))
    message(STATUS "common_base_setting define CMAKE_BUILD_TYPE:${CMAKE_BUILD_TYPE}")
    message(STATUS "common_base_setting define CMAKE_C_FLAGS:${CMAKE_C_FLAGS}")
endif()
